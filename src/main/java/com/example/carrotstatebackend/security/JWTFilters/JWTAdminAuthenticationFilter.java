...
import com.example.carrotstatebackend.security.users.AdminUserDetailsImpl;
...
public class JWTAdminAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    protected void successfulAuthentication(HttpServletRequest request,
        ...
        AdminUserDetailsImpl userDetails = (AdminUserDetailsImpl) authResult.getPrincipal();
